...
### Ошибкки:
Если в терминале возникне ошибка о том, что у вас не установлен Django, после того как вы установили все зависимости с requirements.txt, то вам поможет слудующая команда:
